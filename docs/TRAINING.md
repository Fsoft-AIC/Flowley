...
2. Generate captions capturing detailed information (with both video and sound description).
...
The required parameters for feature extraction are pre-configured in [preprocessing.yaml](../configs/preprocessing.yaml).
